...
export const MOCK_PROFESSIONALS: Professional[] = [
  { id: "p1", businessId: MOCK_BUSINESS_ID, name: "Zé", avatarUrl: null, role: "professional", active: true, commissionPercent: 40 },
  { id: "p2", businessId: MOCK_BUSINESS_ID, name: "Lucas", avatarUrl: null, role: "professional", active: true, commissionPercent: 40 },
  { id: "p3", businessId: MOCK_BUSINESS_ID, name: "Thiago", avatarUrl: null, role: "professional", active: true, commissionPercent: 35 },
];
